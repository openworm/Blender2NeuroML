...
info = '## Blender and corresponding NeuroML images\n\n'
info2 = ''
...
for cell in all_cells:
    ...
    info2 += '    <td>Images generated from original Blender file</td>\n'
    ...
    info2 += '    <td>\n      <img src="../NeuronBlenderImaging/NeuronScreenshots/%s_side.png" alt="%s" height="%s"/><br/>\n'%(cell,cell, height)
    info2 += '       <img src="../NeuronBlenderImaging/NeuronScreenshots/%s_front.png" alt="%s" height="%s"/><br/>\n'%(cell,cell,height)
    info2 += '       <img src="../NeuronBlenderImaging/NeuronScreenshots/%s_top.png" alt="%s" height="%s"/>\n    </td>\n'%(cell,cell, height)
